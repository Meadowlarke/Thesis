...
\begin{document}
	...
	\begin{center}
        \small Washington University in St. Louis \\
                   School of Arts \& Sciences \\
                       Department of Music \\
        \vspace*{1.25in}
        \Large   Playing \textit{with} the Music: \\
        \vspace{0.1cm}
        \large   Ecologies of Attention and Understanding in \\ 
                      the Classical Music Education Project of \textit{Sesame Street}  \\
	\normalsize or \\
	\large The Bird, The Worm, and the Mushroom: \\
	\large Three Stories of Listening\\
        \vspace{0.5cm}
        \normalsize      Eden Attar \\
        \vfill
        \includegraphics[width=0.3\textwidth]{header_logo.png} \\
        \vspace{0.8cm}
	...
	They say that it takes a village to raise a child, but it seems to me 
	that it  takes a village to accomplish just about anything, so I would
	like to thank my village. 

	That is the faculty at WASHU, who have 
	let me run a just a little bit wild: Alex Stafaniak, Paul Stienbeck, 
	Laurn Eldrige Stewart, Todd Decker, and Christopher Douthitt. I would
	like to thank my colleagues Jacob Cupps, Daniel Fister, and Elena Farrel
	for their comments and conversations on this work. I would especially 
	like to thank Jacob for posting their thesis \LaTeX \ files to Github,
	of which I made liberal use in formatting this document. 

	I am forever indebted to the community over at the Muppet Fandom Wiki 
	for all the cataloguing and research that they have made freely 
	available, without which this
	thesis would have looked very different. This thesis would have been
	impossible to write without the use of a Zettelkasten, and I am forever
	grateful to the work of Niklas Luhmann and Sönke Ahrens.

	This project has been guided and sent in new directions by all
	of the friends who made space to explore the ideas that I develop
	in this paper. I would like to thank them all, too many too count,
	but especially, my brunch group, Max Raden, Sarah Winski, Glass, 
	Maël Ng-Pavel, Sage, and my
	friend and personal poet laureate Miles White. 

	\newpage

	I am grateful for the love, community, and support that I found in the 
	anarchist, and non-anarchist, bicycle clubs of St. Louis.\\ 
	...
	To all the friends we made along the way.
	...
	The paper is written in two chapters. The first is an analysis of context,
	...
	Chapter  two is an analysis of classical music performance on the program, 
	...
	encapsulates the dynamic between an aerial listener and a subterranean
	...
	experiencing the internet to mushroom hunting, and looks at recent media
	changes to \ses street consumption.  
	
	\newpage	
	\pagenumbering{arabic}
	\section*{Prologue to Chapter 1 : In \textit{media} res}
	\addcontentsline{toc}{chapter}{Prologue to Chapter 1 : In \textit{media} res}
	...
	\newpage
	\chapter{The Bird-Watcher: Attention, Education, and Entertainment}
	...
	my reading habbits slightly unhealthy. As an experiment,
	however, I have decided to just go ahead and list
	the page numbers as fractions.]{Odell}  
	...
	\begin{quote}
	\subsection{Case Study 1: Itzahk Perlman and ``What's Easy for You
	 is Hard for Me''}
	...
	nor is reverence, authority, or power wielded through hierarchy. 
	...
	the actions in this skit are no less real for being filmed. Perlman actually 
	...
	However, just as a sandbox is a constructed world,
	is a \textit{performance} of a beach, this skit too, is a 
	performance. The steps were put there \textit{so that} Perlman could
	demonstrate the very real struggle that he faces in everyday life.
	...
	\subsection{Case Study 2: Glennie and Linda}
	...
	\newpage
	\section*{Prologue to Chapter 2: Geophones, televisions, worms}
	\addcontentsline{toc}{chapter}{Prologue to Chapter 2: Geophones, televisions, worms}
	...
	mass media}
	\addcontentsline{toc}{section}{The \textit{Young People's Concerts}: 
	classical music and mass media}
	...
	we will see in chapter 2, even parodies of classical music 
	...
	\subsection*{The looking is the beauty}
	\addcontentsline{toc}{section}{The looking is the beauty}
	...
	\newpage
	\chapter{The Worm-Listener: Parody, Virtuosity, and Childhood}
	...
	\subsection{Case Study 3: Ma and the Honkers}
	...
	\addcontentsline{toc}{chapter}{Prologue to forever: Mushrooms, mycelia, the internet}
