...
\begin{document}
  ...
  that the answers to the particular design problems which the writing 
	...
	Worms don't have ears. They are able to hear the movement of other 
	...
	It is reminiscent of one of Oliveros's sconic meditations which
	instructs us to... 	
	...
	1965.\autocite[6]{Glennie} She is one of the first and only musicians 
	to make a career as a solo percussionist. From 
	...
	ears we all listen with other parts of our body, and Glennie is known
	to play without shoes on so that she can better feel both her own and
	other musician's instruments. Glennie sometimes takes advantage of the
	multisensory nature of listening and, in order to convey that she is 
	playing something very quietly, she will sometimes during concerts move
	...
	that most people unconsciously make use of, and gives a glimpse into the
	...
	intersectional with the kind of listening taught on
	\ses so much so that she is far from the only musician who demonstrates
	...
	``Yeah, well, I'm a grouch. I'm not plead to meet anybody. Now scram, 
	...
	Turning to her snare drum, Glennie plays an impressive fill composed of
	 a long roll with a syncopated rhythm marked out on top of it with 
	accented strokes.  
	...
	``Ahhh... Talk about easy listening!'' Oscar inserts as he conducts. 
	...
	challenged by format comedy, pastiche, and general silliness yet
	simultaneously reinforced. Glennie's virtuosity, perhaps because of the
	way that it has been removed from its institutional context, is an 
	approachable, classless, and middlebrow virtuosity with an aesthetic 
	...
	Glennie is something of a controversial figure among the Deaf community. 

	Through dress, public persona, and omnivorous virtuosity, both Glennie
	and Ma transcend highbrow and arrive at the non-planer space of the 
	middlebrow, which is somehow more musically virtuosic and socially 
	virtuous. In both of these cases, it is done through a non-dualistic
	form of listening, which does not see lines of genera, seriousness, 
	or brow.  

Educationally, this is the kind of musicianship that *Sesame Street* endorses.



	Glennie epitomizes a kind of multi-modal full bodied listening. She 
	conceives of sound as a specialized form of touch, and so radicalizes 
	the very meaning of what it means to listen. She brings to \ses 
