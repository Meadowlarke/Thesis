...
\begin{document}
  ...
  that the answers to the particular design problems which the writing 
	...
	onstage conflict with Linda---a lesson in how \texiti{not} to listen
	and a satire of unfair play. 

	This is an example of an enduring aspect of musical guest performances
	on \textiti{Sesame Street} and its presentation of virtuosity: adults 
	...
	In general, virtuosic whimsy is more pronounced in performances
