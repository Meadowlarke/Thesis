...
\begin{document}
  ...
  that the answers to the particular design problems which the writing 
	...
	Between his five appearances on the show in the 1980s he is shown as 
	playing with incredible technical skill and concentration, as 
	omnivorous, and lastly, using the technique of virtuosic whimsy, Ma 
	...
	that it is internalized, and that though he is virtuosic, he and his 
	art are human and approachable. All of these are attained via the ways
	...
	of his \textit{Sesame Street} appearances aired in April, 
	...
	different on \ses than it is in the outside world. Rather than focusing
	...
	In this skit we see a visually Asian Ma play music with an aurally 
	...
	where she write that ``This critical trope casts Asians in a binary 
	...
	Rapso described. Difference, in part with the help of multifaceted 
	musical performance, can blossom into mutual understanding.


	\subsubsection*{Interiority and the limits of understanding}
	...
	scores. Playing without music has long been considered an act of 
	virtuosity in the classical music performance canon. It is an outward 
	...
	performing are necessarily concerned not with playing the notes, but 
	...
	than understanding. Understanding must come from a place which leads to
	 action, lest understanding simply lead to more understanding. That is 
	the limitation of liberal understanding. Empathy can be offered in a 
	...
	it comes from an awareness of our listening positionally: listening 
	...
	asymmetrical. Other skits on the program, such as the Issac Perlman 
	...
	speak into the microphone of the unacknowledged reporter. On \ses, 
	however, the child viewer is given numerous models of fair and radical 
	co-mutual listening. While the Ma example falls short, the basic premise
