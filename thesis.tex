...
\begin{document}
  ...
  that the answers to the particular design problems which the writing 
	...
	boundaries.\autocite[4]{Bull} Bull theorizes ``cultural capital'' as any
	form of value that can be acquired through classical music 
	practices.\autocite[3]{Bull}
	...
	invest the time and resources are unable to participate in its 
	production. This, combined with the idea of ``autonomous'' art which 
	...
	class spaces.\autocite[6]{Bull}

	Put rather frankly by Claire Hall, ability in classical music can be 
	...
	Bernstein's pedagogy does not interact with class is such standard ways.
	The ethos of the \textit{Young People's Concerts} is, as seen in the
	letter above, one of ``education'' not ``pedagogy'' under his 
	definitions of those words. The goal is not to provide uplift for
	underprivileged youth, but instead to acquaint them with new music.   

	However, it is not all bread and roses. Though Bernstein is quoted by
	...
	these other musics, which have been overlooked by white monied society,
	it also re-inscribes the superiority of the metric: western classical
	music. David Hesmondhalgh argues that we should look at the ways that
	...
	music to reinforce the power of the classical music ecology.  
	...
	pedagogy via electronic mass media, the power of the classical music
	...
	worm and the worm listener: those who listen from the inside or from
	the outside. This difference, however, does not have to look like
	class-warfare, but instead can be rather kind, welcoming, and 
	based not in ideas of uplift and comparison to classical metrics, but
	in exposure and entertainment. After all, most viewers of the televised
	\textit{Young People's Concerts} were adults---only 6\% were the
	...
	television allows for
	aerial ears to listen to the underground, and the worms hears the aerial
	listeners listening,    

	\subsection*{Mass Media}

	So far, I have looked at \ses as a piece of 
	children's education media. At this point, I would like to take 
	a step back and look at the program as a piece of art---as a piece of
	popular art. Frankfurt school Marxist and cultural theorist Theodore 
	Adorno, famously problematized popular art and mass media in late
	capitalism. Late capitalism'' or ``late stage capitalism'' 
	...
	Where the worker was first alienated from their labor, they art now also
	alienated from their needs, drives, and imagination.\autocite[66]{Baugh}
	Adorno aruges that popular art masks the alienation inherent to this 
	stage of capitalism by providing diversion and pleasure which in turn 
	provide psychological shelter from the truth of alienation and pacifies 
	the masses.\autocite[67]{Baugh}

	According to Adorno, emancipatory art, unlike art for the masses, would
	bring about the painful experience of being aware of one's own 
	...
	to the listener the inadequacy of normal modes of thinking. This opens 
	...
	able to live off the labour of others and follow intellectual pursuits.
	Adorno's emancipatory art is damned from the start because it requires a
	bourgeois class. \autocite[74]{Baugh} It is in a sense, trickle down 
	emancipation. Baugh argues instead that emancipatory art can arise from
	...
	as uplift and class consciousness expanding by shifting the location of 
	emancipatory art to art from the masses. For these reasons, I do not 
	...
	of Bernstein's public pedagogy. It doesn't have to be difficult, but it
	helps to be unfamiliar. 
