...
\begin{document}
  ...
  that the answers to the particular design problems which the writing 
	...
	species---the limits of which are discussed below. To this effect, 
	classical musicians on \ses demonstrate their virtuosity by \textit{not
	playing} classical music. Take this performance by Yo-Yo Ma:
