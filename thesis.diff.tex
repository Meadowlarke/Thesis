...
%DIF DEL thesisOld.tex   Mon Jul 18 10:16:06 2022
%DIF ADD thesis.tex      Mon Jul 18 10:09:22 2022
...
\newcommand{\ses}{\textit{Sesame Street }}
 %DIF > 
\newcommand\myemptypage{ %DIF > 
	\null %DIF > 
	\thispagestyle{empty} %DIF > 
	\addtocounter{page}{-1} %DIF > 
	\newpage %DIF > 
	} %DIF > 
...
\begin{document}
	...
	questions of parody, virtuosity, \DIFdelbegin \DIFdel{and childhood. It contains three
	}\DIFdelend \DIFaddbegin \DIFadd{childhood, and disability. It 
	is composed of }\DIFaddend character studies of \DIFdelbegin \DIFdel{classical musicians who made appearances on the
	program: }\DIFdelend Yo-Yo Ma \DIFdelbegin \DIFdel{, }\DIFdelend \DIFaddbegin \DIFadd{and }\DIFaddend Evelyn Glennie, 
	\DIFdelbegin \DIFdel{and Lang Lang.   
}%DIFDELCMD < 

%DIFDELCMD < 	
%DIFDELCMD < 	%%%
\DIFdel{In this section I argue that }\textit{\DIFdel{Sesame Street}} %DIFAUXCMD
\DIFdel{takes part in a
...
\DIFdel{neither challenges nor exalts the classical 
	music canon, but rather serves as an enabling technology, a 
	}\textit{\DIFdel{geophone}}%DIFAUXCMD
\DIFdel{, which allows for the aerial listener to perceive and
	engage with the arcane sounds of underworld}\DIFdelend \DIFaddbegin \DIFadd{as the appear on the program}\DIFaddend .   
	...
	\DIFdelbegin \DIFdel{This project takes shape in two media: one is what you are reading 
	right now, the 
	``white paper'' presentation of the research. The other isa 
	non-striated recreation of the field in the form of a Multi User 
	Domain, or MUD.
	The third section of this paper---the mushroom 
	hunter---deals with the themes of diversity, equity, and liberation which inform the project}\DIFdelend \DIFaddbegin \DIFadd{In this section I argue that }\textit{\DIFadd{Sesame Street}} \DIFadd{takes part in a
	long tradition of classical music parody which welcomes the outsider
	while at the same time engages the classical music native and initiate
	---that is, the worm, who has spent its life embedded in the classical
	strata.
	}\textit{\DIFadd{Sesame Street}} \DIFadd{neither challenges nor exalts the classical 
	music canon, but rather serves as an enabling technology, a 
	}\textit{\DIFadd{geophone}}\DIFadd{, which allows for the aerial listener to perceive and
	engage with the arcane sounds of underworld}\DIFaddend .  
	...
	the geological bedrock on which these ecologies are based. \DIFdelbegin %DIFDELCMD < 

%DIFDELCMD < 	%%%
\DIFdel{I'll count myself off: LIGHTS. CAMERA.  
ACTION!	
}\DIFdelend \DIFaddbegin \DIFadd{The paper 
	...
	\newpage	
	\section*{Prologue \DIFaddbegin \DIFadd{to Part I }\DIFaddend : In \textit{media} res}
	...
	and its focus on hearing \DIFdelbegin \DIFdel{common people speak}\DIFdelend \DIFaddbegin \DIFadd{voices from the general public}\DIFaddend . 
	...
	the voices of normal Americans. \DIFdelbegin \DIFdel{Something now }\DIFdelend \DIFaddbegin \DIFadd{While this has never been the exclusive,
	or even most prevalent, style of production for public radio, it has 
	become }\DIFaddend known as the ``public radio sound\DIFdelbegin \DIFdel{.'' }\DIFdelend \DIFaddbegin \DIFadd{'' because of its distinct, 
	recognizable, texture and origin on NPR. 
}\DIFaddend 

	\DIFdelbegin \DIFdel{The sound is recognizable to this day by its lack of a 
	narrator and the featuring of interviewees from the general public. 
It 
	}\DIFdelend \DIFaddbegin \DIFadd{This sound was }\DIFaddend was pioneered by the ``founding mother'' of NPR, radio 
	...
	generally.  \DIFdelbegin %DIFDELCMD < 

%DIFDELCMD < 	%%%
\DIFdelend One particular aspect of the public radio sound was the use
	of ``cross
	...
	\DIFaddbegin \DIFadd{This ``interfering narrator'' is codified in the ``Radio Diaries DIY
	...
	tone of civic life.''}\autocite{Richman} \DIFadd{Allison is arguing here that not only
	...
	\DIFaddend The showcasing of alternative voices was so central to the ethos of \DIFdelbegin \DIFdel{the
	young network that NPR }\DIFdelend \DIFaddbegin \DIFadd{a 
	young NPR that the network }\DIFaddend turned down a \$300,000 donation from 
	the Ford 
	...
	This ethos is visible in public \DIFdelbegin \DIFdel{television as }\DIFdelend \DIFaddbegin \DIFadd{television---\ses media and 
	institutional habitat---as }\DIFaddend well. In the mid-1960s
	...
	\DIFdelbegin %DIFDELCMD < \autocite[294]{Ostrofsky2017}
%DIFDELCMD < 	%%%
\footnote{\DIFdel{Mixed-age television targeting likely began on the 
	television program }\textit{\DIFdel{Captain Kangaroo}}%DIFAUXCMD
\DIFdel{. }%DIFDELCMD < \autocite[46]{Davis}%%%
} 
	%DIFAUXCMD
...
\DIFdel{In terms of music, you see to this effectthe featuring of }\DIFdelend \DIFaddbegin \autocites[294]{Ostrofsky2017}[Mixed-age television targeting likely began on the 
	...
	that the privileged child has never heard blues or gospel\DIFaddbegin \DIFadd{, or is 
	immersed in classical music, }\DIFaddend is over-simplistic, but we see with this 
	...
	``\DIFdelbegin \DIFdel{Grouchy about multiculturalism}\DIFdelend \DIFaddbegin \DIFadd{Interiority and the limits of understanding}\DIFaddend .'' I understand these 
	...
	\DIFdelbegin \DIFdel{I take many cues from sound studies and acoustic ecology, particularly Annea Lockwood. 
	A composer from New Zealand , }\DIFdelend \DIFaddbegin \DIFadd{Practices of listening can be understood from a number of fields,
	...
	relationships.	}\DIFaddend Lockwood is known for her 
	...
	\DIFdelbegin \DIFdel{To understand the practice of listening, I take the definition offered 
	by }\DIFdelend Pauline Oliveros, a contemporary and friend of 
	Lockwood\DIFdelbegin \DIFdel{.}\DIFdelend \autocite[116]{Rodgers}  \DIFdelbegin \DIFdel{In relation to her practice of ``deep 
	listening,'' a complete and intense sonic awareness based in observation	
  rather than judgement, Oliveros distinguishes listening from 
	hearing, clarifying }\DIFdelend \DIFaddbegin \DIFadd{distinguishes }\textit{\DIFadd{listening}} \DIFadd{from 
	}\textit{\DIFadd{hearing}}\DIFadd{, saying }\DIFaddend that ``to hear is the physical means that 
	enables perception.
	To listen is to give attention to what is perceived both acoustically 
	and psychologically.'' \DIFaddbegin \DIFadd{She defined her practice of ``deep listening''
	as a complete and intense sonic awareness based in observation
	rather than judgement. }\DIFaddend \autocite[33/366, As things stand today, e-books
...
%DIFDELCMD < 	%%%
\DIFdel{I take ``listening }\DIFdelend \DIFaddbegin \DIFadd{``Listening }\DIFaddend \textit{with}\DIFdelbegin \DIFdel{'' not as }\DIFdelend \DIFaddbegin \DIFadd{,'' then is not }\DIFaddend ``hearing \textit{with},'' 
	...
	\DIFdelbegin \DIFdel{My understanding of attention and my larger framework for understanding
	the media ecology of children's television comes from the theories 
	developed }\DIFdelend \DIFaddbegin \DIFadd{The social and artistic significance of attention is analyzed }\DIFaddend by Jenny
	Odell in \textit{How To Do Nothing}, a book at the intersection of media
	theory
	and ecology. Odell places attention \DIFdelbegin \DIFdel{as }\DIFdelend \DIFaddbegin \DIFadd{at }\DIFaddend the center of ethics\DIFdelbegin \DIFdel{. }\DIFdelend \DIFaddbegin \DIFadd{: }\DIFaddend We decide 
	who is seen, who is heard, and who has agency, through acts of 
	attention. \autocite[154]{Odell} \DIFdelbegin \DIFdel{I propose that Odell can help us 
	interpret the soundscape of
	}\textit{\DIFdel{Sesame Street}} %DIFAUXCMD
\DIFdel{and the listening
	which it cultivates. I take her theories of attention as my primary
	framework for the ecologies of music and understanding
	prevalent in the program}\DIFdelend \DIFaddbegin \DIFadd{\ses is constantly showcasing acts of
	...
	listening that \ses teaches}\DIFaddend . I make this shift away from traditional
...
%DIFDELCMD < 	
%DIFDELCMD < 	%%%
\DIFdelend This ecological, attention-based understanding of the world requires 
	...
	\DIFdelbegin \DIFdel{This is musically apparent }\DIFdelend \DIFaddbegin \DIFadd{Bird listening musical behavior takes place }\DIFaddend in the skits of \DIFaddbegin \DIFadd{early }\DIFaddend Muppet
	Simon Soundman\DIFaddbegin \DIFadd{, who has a phonographically accurate voice and often
	substitutes nouns for the sounds that they make}\DIFaddend .  
...
%DIFDELCMD < 	%%%
\DIFdelend \DIFaddbegin \ttfamily
	\DIFaddend ``Uh... Oh... Would you mind repeating that, sir?''
	...
	big band. \DIFaddbegin \DIFadd{Simon's shtick is that he substitutes nouns with sounds. This
	...
	\DIFaddbegin \DIFadd{Of course, their experiences are not equal---being a novice violinist does
	...
	listening \textit{with}. \DIFdelbegin %DIFDELCMD < 

%DIFDELCMD < 	%%%
\DIFdelend One might object that this is \textit{media}, 
	...
	\DIFdelbegin \DIFdel{I use this term }\textit{\DIFdel{non-striated}} %DIFAUXCMD
\DIFdel{to denote a space which is not
	...
	material only and not itself a work of \DIFdelbegin \DIFdel{art}\DIFdelend \DIFaddbegin \DIFadd{highly intentional and expertly
	crafted media}\DIFaddend . Analyzing \ses as \DIFdelbegin \DIFdel{art }\DIFdelend \DIFaddbegin \DIFadd{virtuosically constructed media }\DIFaddend opens a
...
\DIFdelend Taking as my definition of anarchism, ``the principled opposition to 
	...
	\DIFdelbegin \DIFdel{My analysis via these philosophies does the work of highlighting this 
	...
	analyze these aspects of }\DIFdelend \DIFaddbegin \DIFadd{This section has analyzed the ways that attention and understanding 
	play out in the educational project of }\DIFaddend \textit{Sesame Street\DIFaddbegin \DIFadd{.}\DIFaddend } 
	\DIFdelbegin \DIFdel{’s musical educationwhich have gone overlooked. 
	This is germane to scholars of 
	}\textit{\DIFdel{Sesame Street}}%DIFAUXCMD
\DIFdel{, television, and children’s media. On the other 
...
%DIFDELCMD < 	%%%
\DIFdel{This is not, mind you, a paper on how deschooling can save education and
...
%DIFDELCMD < 	%%%
\DIFdel{Rather,
	this section has been a critical look into the emergent design 
	...
	program, this study has ramifications for the present moment of education. That said, my goal is not to suggest that instructors remove 
	their attendance requirements and stop assigning letter grades, but 
	rather, in an Odellian sense, to teach the bird-song of 
	non-coercion 
	so that it may be appreciated where it perches}\DIFdelend \DIFaddbegin \DIFadd{\ses gives us insight into alternatively distributed and 
	...
	\newpage	
	\DIFaddbegin \myemptypage


	\newpage
	\DIFaddend \section*{Prologue \DIFaddbegin \DIFadd{to Part II}\DIFaddend : Geophones, televisons, worms}
	...
	\DIFdelbegin \DIFdel{Worms }\DIFdelend \DIFaddbegin \DIFadd{The worms may have heard me, but worms }\DIFaddend don't have ears. They are able 
	to hear the movement of other 
	animals, to hear \textit{my} movements above them\DIFaddbegin \DIFadd{, }\DIFaddend though their very
	...
	mechanism. \DIFdelbegin %DIFDELCMD < 

%DIFDELCMD < 	%%%
\DIFdelend It is reminiscent of one of Oliveros's sconic meditations 
	which instructs us to \DIFdelbegin \DIFdel{..}\DIFdelend \DIFaddbegin \DIFadd{``Take a walk at night. Walk so silently that the
	bottoms of your feet become ears.''}\autocite{Oliveros} \DIFadd{Ears are to air
	...
	move us towards these different forms of listening}\DIFaddend .
	...
	culture. \DIFaddbegin \DIFadd{The goal of the program was not uplift through classical
	...
	This program \DIFdelbegin \DIFdel{marks }\DIFdelend \DIFaddbegin \DIFadd{marked }\DIFaddend a different way of doing classical 
	music
	...
	of anecdotes and nothing about music, or \DIFaddbegin \DIFadd{formalistic }\DIFaddend analysis. He saw 
	...
	affective-reactive meanings \DIFdelbegin \DIFdel{(}\DIFdelend like triumph or melancholy\DIFdelbegin \DIFdel{)}\DIFdelend , and purely 
	musical meanings \DIFaddbegin \DIFadd{such as musical jokes}\DIFaddend .\autocite[14]{Kopfstein}  His 
...
\DIFdelend The idea of classical music providing economic and spiritual uplift from
	...
	\section*{\DIFdelbegin \DIFdel{Mass media}\DIFdelend \DIFaddbegin \DIFadd{The looking is the beauty}\DIFaddend }

	\DIFdelbegin \DIFdel{So far, I have looked at \ses as a piece of children's educational media . At this point, I would like to take 
	a step back and 
	look at the program as a piece of art---as a piece of popular art . Frankfurt school Marxists and cultural theorists Theodore 
	Adorno and Max }\DIFdelend \DIFaddbegin \DIFadd{I have written against the idea of art as uplift. However, art and
	...
	}\textit{\DIFadd{Yorkshire Landscapes}} \DIFadd{to television that ``if you show the world
	better, it's more beautiful, a lot more beautiful. The process of 
	looking is the beauty.''}\autocite[100]{Odell} \DIFadd{This remark points to the
	...
	}\textit{\DIFadd{listening with}} \DIFadd{that it showcases. Ultimately, as we will
	see in part II of this paper, the looking as the beauty can provide
	spaces for social discourse and change. 
}

	\DIFadd{This may share some superficial similarity to the theories of mass media
	...
	\DIFadd{Adorno and }\DIFaddend Horkheimer famously problematized popular art and
	...
	Enlightenment as mass deception.''\autocite{Adorno} \DIFaddbegin \DIFadd{``}\DIFaddend Late capitalism'' 
	...
	goal of, Bernstein's public pedagogy \DIFaddbegin \DIFadd{with its focus on teaching musical
	connoisseurship and appreciation }\DIFaddend as well as the musical education 
	on \textit{Sesame Street} \DIFdelbegin \DIFdel{. It doesn't have to be difficult, 
	but it helps to be unfamiliar}\DIFdelend \DIFaddbegin \DIFadd{and its goals of socio-emotional learning}\DIFaddend . 
	...
	\DIFdelbegin \DIFdel{moving 
	}\DIFdelend \DIFaddbegin \DIFadd{recital-style 
	}\DIFaddend performances of the classics into what were otherwise comedy 
	...
	\DIFaddbegin \DIFadd{Parodies of classical music such as those in the Marx Brothers's 
	}\textit{\DIFadd{A Night at the Opera}} \DIFadd{or the animated short film 
	}\textit{\DIFadd{What's Opera, 
	Doc?}} \DIFadd{uphold the status of classical music as much as they deride it. By
	setting up the elite musical culture as an object worthy of deflation, 
	its status and spectacle are preserved in their high 
	place.}\autocite[252]{Garrett} \DIFadd{The representations of classical music in
	}\textit{\DIFadd{A Night at the Opera}} \DIFadd{simultaneously ``punches up'' to classical
	...
	\DIFaddend Making fun \textit{with} the music resonates with Annea Lockwood's 
	...
	}\textit{\DIFdel{A Night at the Opera}} %DIFAUXCMD
...
\DIFdel{uphold the status of classical music as much as they deride it. By
	setting up the elite musical culture as an object worthy of deflation, 
	its status and spectacle are preserved in their high 
	place.}%DIFDELCMD < \autocite[252]{Garrett} %%%
...
\DIFdel{simultaneously ``punches up'' to classical
	...
	classical world, it offered nuanced entertainment to those with a 
	knowledge and admiration of opera.}%DIFDELCMD < \autocite[251]{Garrett} 
%DIFDELCMD < 
...
\DIFdelend Borge said that it was generally the case that those who laughed
	...
	semi-circularly in the way that \DIFdelbegin \DIFdel{singers }\DIFdelend \DIFaddbegin \DIFadd{chamber ensembles }\DIFaddend often do.
	...
	perspective. \DIFaddbegin \DIFadd{In this performance Ma and the ensemble break from the 
	...
	and highlight Ma's
	willingness to }\textit{\DIFadd{play.}} \DIFadd{The professional, grown up, Ma and his
	}\textit{\DIFadd{very}} \DIFadd{expensive cello}\autocites[I haven't been able to 
	...
	Stradivarius valued
	at \$2.5 million.]{Times} \DIFadd{break the continuity 
	of the classical piece in 
	order to engage in conversation with the sorts of sounds you would
	find in a child's toybox or attached to their tricycle. }\DIFaddend Both the Ma and
	Galway performances 
...
\DIFaddbegin 
	...
	1965.\autocite[6]{Glennie} She is one of the first and only \DIFaddbegin \DIFadd{western 
	}\DIFaddend musicians to make a career as a solo percussionist. From 
	around the age of eight, Glennie began to lose her 
	hearing.\autocite[40]{Glennie} \DIFdelbegin \DIFdel{Around }\DIFdelend \DIFaddbegin \DIFadd{In response to }\DIFaddend these changes, she 
	developed an 
	...
	ears we all listen with other parts of our body\DIFdelbegin \DIFdel{, and }\DIFdelend \DIFaddbegin \DIFadd{. }\DIFaddend Glennie is known
	to play without shoes on so that she can better feel \DIFdelbegin \DIFdel{both }\DIFdelend \DIFaddbegin \DIFadd{the sounds of }\DIFaddend her 
	...
	playing something very quietly, \DIFdelbegin \DIFdel{she will sometimes during concerts }\DIFdelend \DIFaddbegin \DIFadd{during concerts will }\DIFaddend move
	her mallets without actually striking the notes. She says that ``\DIFdelbegin \DIFdel{If }\DIFdelend \DIFaddbegin \DIFadd{if }\DIFaddend I 
	...
	that most people \DIFdelbegin \DIFdel{unconsciously make use of}\DIFdelend \DIFaddbegin \DIFadd{are unconsciously taking part in}\DIFaddend , and gives a glimpse 
	into the
	...
	and that \textit{\DIFdelbegin \DIFdel{Earing,}\DIFdelend \DIFaddbegin \DIFadd{earing}\DIFaddend }---perceiving through the \DIFdelbegin \DIFdel{ears--is }\DIFdelend \DIFaddbegin \DIFadd{ears---is }\DIFaddend not the 
	...
	\DIFdelbegin \DIFdel{intersectional }\DIFdelend \DIFaddbegin \DIFadd{resonant }\DIFaddend with the kind of listening taught on
	\ses so much so that she is far from the only musician who \DIFdelbegin \DIFdel{demonstrates
	}\DIFdelend \DIFaddbegin \DIFadd{engages in
	}\DIFaddend mulitmodal listening. In the Ma and Honkers skit, Yo-Ya Ma demonstrates
	...
	aurally. \DIFaddbegin \DIFadd{In one of Glennie's appearances on the program, her virutosity
...
\DIFaddbegin 
	...
	\DIFaddend The scene opens with Oscar and Telly peeking over Oscar's trash cans. 
	...
	``Yeah, well, I'm a grouch. I'm not \DIFdelbegin \DIFdel{plead }\DIFdelend \DIFaddbegin \DIFadd{pleased }\DIFaddend to meet anybody. Now scram, 
	will ya'?I've got a \DIFdelbegin \DIFdel{Grouchcateer }\DIFdelend \DIFaddbegin \DIFadd{Grouchketeer }\DIFaddend band practice going on.''

	``B-b-bu-but-but Oscar, Evelyn's always dreamed of playing in the 
	\DIFdelbegin \DIFdel{Grouchcateer }\DIFdelend \DIFaddbegin \DIFadd{Grouchketeer }\DIFaddend band.''

	``Absolutely! And look at the wonderful instruments that you have." 
	Glennie motions to the pile of garbage.  

	``Well, you can't play in the \DIFdelbegin \DIFdel{Grouchcateer }\DIFdelend \DIFaddbegin \DIFadd{Grouchketeer }\DIFaddend band, 'cause you're not a 
	\DIFdelbegin \DIFdel{Grouchcateer}\DIFdelend \DIFaddbegin \DIFadd{Grouchketeer}\DIFaddend .''
	...
	Turning to her snare drum, Glennie plays an \DIFdelbegin \DIFdel{impressive fill composed of
	 a long rollwith a syncopated rhythm marked out }\DIFdelend \DIFaddbegin \DIFadd{impressively smooth buzz 
	roll. She taps out syncopated rhythm }\DIFaddend on top of it with accented \DIFdelbegin \DIFdel{strokes}\DIFdelend \DIFaddbegin \DIFadd{strikes
	to the drum head}\DIFaddend .
	...
	``So, can she play in the \DIFdelbegin \DIFdel{Grouchcateer }\DIFdelend \DIFaddbegin \DIFadd{Grouchketeer }\DIFaddend band?''
	...
	just to play in the \DIFdelbegin \DIFdel{Grouchcateer }\DIFdelend \DIFaddbegin \DIFadd{Grouchketeer }\DIFaddend band, and Evelyn can play just about 
	anything.''
	...
	``S- so- so can she play in the \DIFdelbegin \DIFdel{Grouchcateer }\DIFdelend \DIFaddbegin \DIFadd{Grouchketeer }\DIFaddend band?''

	``Play in it? I hope she never stops!''

	``Oh Oscar, thank you.''

	``And now, the \DIFdelbegin \DIFdel{Grouchcateer }\DIFdelend \DIFaddbegin \DIFadd{Grouchketeer }\DIFaddend band will play, \textit{Sonata for crushed 
	cans, torn boots, dented horn, and trashcan} by Ludwig von 
	Blech-toven.''

	``Oh, great!'' Glennie raises her sticks in appreciation.  

	``Yeah, heh heh. Okay \DIFdelbegin \DIFdel{Grouchcateers}\DIFdelend \DIFaddbegin \DIFadd{Grouchketeers}\DIFaddend , a one and a two and---''

	The players break out into \DIFdelbegin \DIFdel{Cacophony}\DIFdelend \DIFaddbegin \DIFadd{cacophony}\DIFaddend . 

	``Ahhh... Talk about easy listening!'' Oscar \DIFdelbegin \DIFdel{inserts }\DIFdelend \DIFaddbegin \DIFadd{muses }\DIFaddend as he conducts. 
	...
	a step up in capacity for virtuosic display \DIFaddbegin \DIFadd{where she showcases and
	embodies a sense of boundary-less child-like play and ``gameness'' to 
	approach a challenge}\DIFaddend . This is another example of
	the ways that the status of the classical music establishment is 
	challenged by format comedy, pastiche, and general silliness\DIFdelbegin \DIFdel{yet
	}\DIFdelend \DIFaddbegin \DIFadd{, yet is
	}\DIFaddend simultaneously reinforced. Glennie's virtuosity, perhaps because of the
	way that it has been removed from its institutional context, is  
	\DIFdelbegin \DIFdel{an 
	}\DIFdelend approachable, classless, \DIFdelbegin \DIFdel{and middlebrow virtuosity with }\DIFdelend \DIFaddbegin \DIFadd{omnivorous, and has }\DIFaddend an aesthetic 
	taste which is wider than what is normally performed in classical
	music halls. \DIFaddbegin \DIFadd{This is a common role that Oscar and other Grouches play
	...
	\DIFadd{Grouches also seems to represent the icky childhood spirit that takes
	...
	give space for Gelnnie to perform childhood and the beginners eyes that
	...
	\DIFaddbegin \DIFadd{When she played at the BBC's Proms in 1989, she very intentionally chose
	a more casual outfit which included pants rather than a dress, in order
	to seem more approachable.  
}

	\subsection*{\DIFadd{Disability and the politics and poetics of listening}}	
\DIFaddend 


	Glennie \DIFdelbegin \DIFdel{is something of a controversial figure among the Deaf community}\DIFdelend \DIFaddbegin \DIFadd{does not like to have her deafness highlighted in her 
	...
	\DIFadd{While the view of hearing loss that Glennie's persona presents is 
	...
	}\textit{\DIFadd{Sesame Street}}\DIFadd{, she told the magazine }\textit{\DIFadd{Parade}} \DIFadd{that 
	``I don't see
	...
	2008.}\autocite[186]{Holmes} \DIFadd{Her defeatist conceptions of what it means 
	to be Deaf,  
	...
	individual
	who }\textit{\DIFadd{should}} \DIFadd{be able to overcome their disability. These tropes 
	are distinct from the visual and tactile acuities associated with 
	hearing loss---or as some prefer, Deaf 
	Gain}\autocite[174]{Holmes}\DIFadd{---which are better understood as cultural 
	practices that exist within the Deaf community.}\autocite[181]{Holmes}

	\DIFadd{Gelnnie encapsulates everything which is messy about listening. Though 
	...
	listening,''}\autocite{GlennieOnline} \DIFadd{takes listening
	...
	playing music'---vibrations only! I don’t identify }[\DIFadd{it}] \DIFadd{as
	music.''}\autocite[184]{Holmes} \DIFadd{Furthermore, Glennie's forms of
	...
	moments in her film }\textit{\DIFadd{Touch the Sound}} \DIFadd{where the uniqueness of 
	...
	less the same as that of the other musicians she plays with}\DIFaddend .  

	\DIFaddbegin \DIFadd{Glennie brings her multimodal listening practices to the musical 
	educational project of }\textit{\DIFadd{Sesame Street}} \DIFadd{and the forms of
	...
	this deconstructed listening to }\textit{\DIFadd{Sesame Street}}\DIFadd{, where, 
	...
	establishment that they take part in. }\DIFaddend Through dress, public persona, and
	omnivorous virtuosity, both Glennie
	and Ma transcend \DIFaddbegin \DIFadd{the }\DIFaddend highbrow and arrive at the non-planer space of the 
	middlebrow, which is somehow more musically virtuosic and socially 
	virtuous. In both of these cases \DIFdelbegin \DIFdel{, }\DIFdelend it is done through \DIFdelbegin \DIFdel{a }\DIFdelend \DIFaddbegin \DIFadd{an apparently  
	}\DIFaddend non-dualistic form of listening \DIFdelbegin \DIFdel{, }\DIFdelend which does not see lines of genera, 
	seriousness, or \DIFdelbegin \DIFdel{brow. }%DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdel{Educationally, this is the kind of musicianship that *Sesame Street* endorses. }\DIFdelend \DIFaddbegin \DIFadd{class. Historically, classical music has tended toward
	highly prescriptive modes of listening, consumption, and production. 
	}\textit{\DIFadd{Sesame Street}}\DIFadd{, in an effort toward class inclusion, intervenes
	...
	the listener is participating, is }\textit{\DIFadd{listening with}}\DIFadd{, rather than 
	as an object to which they listen.}\autocite[109]{Ceraso}
\DIFaddend 

	Glennie \DIFdelbegin \DIFdel{epitomizes a kind of multi-modal full bodied listening . She 
	conceives of sound as a specialized form of touch, and
	so radicalizes 
	the very meaning }\DIFdelend \DIFaddbegin \DIFadd{encapsulates the promise and shortcomings of listening on 
	}\textit{\DIFadd{Sesame Street}}\DIFadd{: though it offers to heal wounds of class and 
	...
	\DIFadd{Furthermore, in terms of ability and disability,
	...
	conditions of the workplace.}\autocite[208]{Holmes} \DIFadd{Sound scholar 
	...
	advanced capitalism. }[\DIFadd{It}] \DIFadd{is both a form of inscription on the body, and
	...
	scarification.''}\autocite[204]{Holmes} \DIFadd{Hearing loss/Deaf gain is a 
	...
	rather, this }\textit{\DIFadd{hearer}} \DIFadd{is a transitory and illusory character,
	as, after all, we will all be disabled eventually if we live long 
	enough.
}

	\DIFadd{I am not arguing that }\textit{\DIFadd{Sesame Street}} \DIFadd{or Evelyn Glennie are doing
	...
	of nuance, painting a broad and multi-valent picture }\DIFaddend of what it means 
	to listen\DIFdelbegin \DIFdel{. She brings to \ses 
	this deconstructed listening.  
}\DIFdelend \DIFaddbegin \DIFadd{, from the shopkeeper listenining to Simon Soundman's 
	...
	a framework for }\textit{\DIFadd{listening-}} \DIFadd{and }\textit{\DIFadd{playing with}}\DIFadd{. 
}


	\newpage
	\section*{\DIFadd{Prologue to forever: Mushrooms, mycelia, the internet}}

	\DIFadd{There is an image I have seen a few times surrounding discussions of 
	...
	\DIFadd{Befitting the similarities in structure between the internet and a 
	...
	\DIFadd{But what even is this thing that we call the }\textit{\DIFadd{internet}}\DIFadd{? It is 
	...
	the }\textit{\DIFadd{internet}} \DIFadd{but rather a }\textit{\DIFadd{web service.}} \DIFadd{The internet is
	...
	\DIFadd{This wire is now where \ses has taken up residence. 
	...
	Saint
	Louis broadcasts }\textit{\DIFadd{Sesame Street}} \DIFadd{twice a week---but episodes air
	9-months after they appear on HBO.}\autocite{Koblin} \DIFadd{This 
	might mean that something like this years juneteenth episode may never 
	air on public television at all. 
}

	\DIFadd{There is also a collection of segments from the program at 
	...
	broadband subscription,}\autocite[2]{Martin} \DIFadd{whereas when \ses launched 
	in 1969, 95\% of 
	households had a television set.}\autocite[142]{Steinberg} \DIFadd{It is quite 
	possible that \ses is less
	accessible now than it has ever been, especially for disenfranchised
	populations. 
}

	\DIFadd{It seems to me that the real Sesame playground, in the mushroom-hunting
	sense, is not at 
	...
	engaging with \ses, a fixture of their own or their childrens'
	...
	scary.}\autocite{NBC} \DIFadd{These
	...
	``looses his sh}\*t \DIFadd{over a rock,'' as one bootleg YouTube upload of the 
	...
	\DIFadd{This is the mushroom-hunting spirit creating a collective conversation 
	about }\textit{\DIFadd{Sesame Street}}\DIFadd{. Though it is sometimes crude, I 
	...
	\DIFadd{I am tempted to frame this behaviour as a kind of ``post-listening.'' If
	...
	shape as nostalgia, the collection and love of trica, and---as in the
	case of Hellmo---sheer transgression.   
}

	\DIFadd{Mushrooms are also the delicious fruit of decay, apples growing out of 
	rot. Similarly, the internet's fascination with \ses comes at 
	the time of the decay of broadcast television. These are the 
	fruits of decay, and so was }\textit{\DIFadd{Sesame Street,}} \DIFadd{coming out of a 
	...
	\DIFadd{Given, on the other hand, how nasty the internet can be, I hope that 
	post-listening is not to listening as post-truth is to truth. I hope
	that
	post-listening does not come to mean }\textit{\DIFadd{not-listening}}\DIFadd{, eschewing 
	it	
	...
	how, and, if you ask me, I'd say that's how we get to }\textit{\DIFadd{Sesame 
	Street.}} 
\DIFaddend 
